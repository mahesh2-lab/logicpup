  ...
  // ── Level 10 ────────────────────────────────────────────────────────────────
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        levelId: "level-10",
        levelNumber: 10,
        title: "LogicPup Master Capstone Game 🐾",
        difficulty: "hard",
        format: "real_world",
        formatLabel: "🌍 Real-World App",
        description: "Ask user for secret password 'PUP'. If 'PUP' print '✨ CONGRATULATIONS LOGICPUP MASTER! 🎓 🐾 ✨', else print 'Access Denied'.",
        goal: "Build the master capstone verification engine.",
        hint: "Verify password 'PUP' and award master status.",
        points: 250,
        testCases: [
          {
            id: "l10-c3-t1",
            name: "Master Unlocked (PUP)",
            inputs: ["PUP"],
            expectedOutputs: ["LOGICPUP MASTER"],
          },
          {
            id: "l10-c3-t2",
