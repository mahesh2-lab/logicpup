...
import { BookOpen, Terminal, Heart } from "lucide-react";

export const Footer: React.FC = () => {
  return (
    <footer
      id="logicpup-footer"
      className="border-t border-black/6 bg-white/60 py-12 md:py-16 text-[#666666]"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-black/[0.06]">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-sm bg-[#F26A3D] text-white flex items-center justify-center shadow-xs overflow-hidden">
                <Image
                  src="/logo.png"
                  alt="LogicPup Logo"
                  width={32}
            ...
            <p className="text-xs sm:text-sm text-[#666666] leading-relaxed max-w-sm">
              The playful interactive learning environment where visual logic
              flowcharts fetch real Python 3 code. Built with ❤️, logic, and
              zero syntax errors.
            </p>
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs">
                ...
                <li>
                  <a
                    href="#interactive-demo-playground"
                    className="hover:text-[#121212] transition-colors"
                  >
